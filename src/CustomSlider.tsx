...
import { createElement, useState, useMemo, useRef, useEffect, useCallback } from "react";
        ...
        <div className={rootClass} style={cssVars} aria-label={ariaLabel} aria-labelledby={ariaLabelledBy}>
            <div className="slider-wrapper">
                ...
                <div className="slider-overlays">
                    ...
                    {minShowTooltip && (
                        <div className={`slider-tooltip visible ${minTooltipPosition === "bottom" ? "bottom" : "top"}`}
                            style={posStyle(0, "left")}>
                            {getTooltipText(minTooltipType as any, minTooltipTemplate, min)}
                        </div>
                    )}
                    {maxShowTooltip && (
                        <div className={`slider-tooltip visible ${maxTooltipPosition === "bottom" ? "bottom" : "top"}`}
